...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/js/logined/photo/photoList.js"></script>
<script type="text/javascript"
...
<body class="easyui-layout">
	<div class="easyui-panel" data-options="fit:true,border:false"
		...
		<div data-options="region:'center'"
			...
			<table id="photo" toolbar="#tb" width='100%' height='100%'
				toolbar="photoInfGridTB" fit='true' class="easyui-datagrid">
			...
			<div id="tb">
				<div>
					<table>
						<tr>
							<td>拍摄编号：</td>
							<td><input class="easyui-textbox" id="photoNo"
								name="photoNo" style="width: 150px" /></td>
							<td>拍摄日期：</td>
							<td><input class="easyui-datebox" id="photoTime" name="photoTime"
