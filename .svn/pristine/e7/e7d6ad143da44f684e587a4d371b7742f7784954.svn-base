...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	...
	<!--修改密码窗口-->
	<div id="w" class="easyui-window" title="修改" collapsible="false"
			...
			<div region="center" border="false"
				...
				<form id="fm" action="">
					<table cellpadding=3>
						<tr>
							<td>原密码：</td>
							<td><input id="oldPass" name="oldPass" type="Password"
						...
						<tr>
							<td>确认密码：</td>
							<td><input id="reNewPass" name="reNewPass" type="Password"
								class="easyui-validatebox" data-options="required:true" /></td>
						</tr>
					</table>
				</form>
		...
		$.ajax({
			...
			success : function(data) {
				...
				if (data == 3) {
					...
					/* $.messager.alert("提示信息", "操作成功").confirm(function () {
                window.location.href=basePath+"/rediectLoginPage.action";
            }); */
					/* $.window.location.href = "basePath+'/rediectLoginPage.action'"; */
				} else if (data == 2) {
